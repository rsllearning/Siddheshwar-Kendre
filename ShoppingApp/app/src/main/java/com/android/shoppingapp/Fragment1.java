...
public class Fragment1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewModel = viewModelProvider.get(ViewModel1.class);
...
//        });
    ...
    private void handleGamesList(List<DataModel> dataModels) {
        int position = 0;
        RecyclerViewAdapter adapter = new RecyclerViewAdapter(dataModels,getContext(),position);

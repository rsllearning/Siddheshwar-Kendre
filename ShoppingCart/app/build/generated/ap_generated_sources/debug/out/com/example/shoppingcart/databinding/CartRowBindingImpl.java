...
public class CartRowBindingImpl extends CartRowBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.deleteProductButton, 4);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.cartItem == variableId) {
            setCartItem((com.example.shoppingcart.models.CartItem) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setCartItem(@Nullable com.example.shoppingcart.models.CartItem CartItem) {
    ...
    protected void executeBindings() {
        ...
        com.example.shoppingcart.models.Product cartItemProduct = null;
        double cartItemProductPrice = 0.0;
        java.lang.String cartItemProductName = null;
        com.example.shoppingcart.models.CartItem cartItem = mCartItem;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.example.shoppingcart.models.Product.loadImage(this.productImageView, cartItemProductImageUrl);

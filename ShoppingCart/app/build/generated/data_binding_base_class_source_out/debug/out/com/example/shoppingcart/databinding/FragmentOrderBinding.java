...
public final class FragmentOrderBinding implements ViewBinding {
  ...
  private FragmentOrderBinding(@NonNull LinearLayout rootView,
      @NonNull Button continueShoppingButton) {
  ...
  public static FragmentOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      Button continueShoppingButton = rootView.findViewById(id);
      if (continueShoppingButton == null) {
        break missingId;
      }

      return new FragmentOrderBinding((LinearLayout) rootView, continueShoppingButton);
    }
